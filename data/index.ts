...
export const workExperience = [
  {
    ...
    work: [
      "Led the architecture and development of an Agentic AI platform using Mastra, NestJS, and MongoDB for scalable multi-agent orchestration, DAG-based planning, and intelligent workflow automation.",
      "Built a scalable React-based Agent Builder with custom Slate.js plugins, enabling intuitive configuration of tools, workflows, and prompt-to-agent creation using natural language.",
      "Developed a hybrid RAG retrieval system using BM25 and vector search with multi-provider embeddings for accurate semantic discovery of tools and triggers.",
      "Engineered advanced agent capabilities including plan-execute-replan workflows, reusable Agent Skills, agent memory, structured outputs, and Human-in-the-Loop controls for reliable AI execution.",
      "Implemented enterprise AI guardrails with prompt injection detection, content moderation, and an LLM-as-Judge evaluation framework with 18+ custom scorers integrated with Arize.",
      "Led the development of a production-grade MCP server exposing agent capabilities through the Model Context Protocol (MCP) for AI-assisted developer workflows.",
      "Built integrations with OpenAI, AWS Bedrock, Airtable, BigCommerce, Box, and Microsoft Teams to extend enterprise automation capabilities.",
      "Engineered a high-performance Live Preview SDK using Preact and NestJS microservices, enabling real-time collaborative editing with threads and comments.",
      "Mentored engineers, drove architectural decisions, and collaborated across product and engineering teams to deliver enterprise-scale AI platform initiatives.",
    ],
  },
  {
    id: 2,
